...
class User < ActiveRecord::Base
  ...
  attr_accessible :email, :nom, :password, :password_confirmation, :date_naissance, :cv, :films_vu_par_semaine, :lire_plus_livres
  ...
  # avant d'enregistrer appeler la method  encrypt_password !
